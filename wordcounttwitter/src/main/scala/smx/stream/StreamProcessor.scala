...
//sc.getConf.set("spark.ui.port", "44040" )
...
//    json.toDF().createOrReplaceTempView("json_tweets")
    json.toDF().registerTempTable("json_tweets")
//    json.registerTempTable("json_tweets")
